function void = main_FigureS2_SC2_calculate(void)
...
for thresh = 1:3
    ...
    for R0val = 1:3
        ...
        outfileS2_SC2 = strcat('figureS2_SC2_results_thres', int2str(thresh), '_R0', int2str(R0val));
        ...
        save(outfileS2_SC2, 'params', 'results');
